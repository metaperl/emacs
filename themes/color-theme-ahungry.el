...
(defun color-theme-ahungry ()
  ...
  (color-theme-install
   '(color-theme-ahungry
     ...
     (mode-line ((t (:foreground "#0022ff" :bold t :background "#44cc00"
     ...
     (font-lock-comment-face ((t (:foreground "#888a85" :bold t :italic t))))
     ...
     (font-lock-string-face ((t (:foreground "#ff0055" :italic t :bold t))))
     ...
     (diff-added ((t (:foreground "#8aa234"))))
